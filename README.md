...
this refers to having a table like structure

2. Why do tables need a Primary Key?

so they can be referenced in other tables and they can represent one unique record
...
we need a third appointment table.
